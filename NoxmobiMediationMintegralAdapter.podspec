...
Pod::Spec.new do |spec|
  ...
  spec.dependency "MintegralAdSDK/BannerAd", "7.1.6.0"
  spec.dependency "MintegralAdSDK/InterstitialVideoAd", "7.1.6.0"
  spec.dependency "MintegralAdSDK/RewardVideoAd", "7.1.6.0"
